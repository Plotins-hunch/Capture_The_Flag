...
public class AdvancedGameSimulatorTest {

  private AdvancedGameSimulator simulator;
  ...
  public void setUp() {
    ...
    simulator = new AdvancedGameSimulator(initialState);
  }
  ...
  public void testSimulateGame_WinnerDetermined() {
    ...
    simulator = new AdvancedGameSimulator(winState);
  ...
  public void testSimulateGame_NoMovesLeft() {
    ...
    simulator = new AdvancedGameSimulator(noMoveState);
  ...
  public void testHandleConflict_PieceCapture() {
    ...
    simulator = new AdvancedGameSimulator(captureState);
  ...
  public void testHandleConflict_BaseCaptureEndsGame() {
    ...
    simulator = new AdvancedGameSimulator(baseCaptureState);
