...
class AdvancedGameStateCopierTest {
  ...
  void testDeepCopyGameState() {
    GameState copied = AdvancedGameStateCopier.deepCopy(original);
  ...
  void testDeepCopyTeam() {
    ...
    Team copiedTeam = AdvancedGameStateCopier.deepCopyTeam(originalTeam);
  ...
  void testDeepCopyPiece() {
    ...
    Piece copiedPiece = AdvancedGameStateCopier.deepCopyPiece(originalPiece);
