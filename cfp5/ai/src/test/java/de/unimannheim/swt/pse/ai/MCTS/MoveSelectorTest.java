...
import de.unimannheim.swt.pse.ai.mcts.MoveSelector;
...
public class MoveSelectorTest {
  ...
  public void testGetAllPossibleMoves_NoMoves() {
    ...
    moveSelector = new MoveSelector(gameState);
  ...
  @Test
  public void testGetPossibleMovesForPiece_NoMoves() {
    GameState gameState = gameStateFactory.createNoMovesLeftState();
    moveSelector = new MoveSelector(gameState);
    List<Move> possibleMoves = moveSelector.getAllPossibleMoves();
    assertTrue(possibleMoves.isEmpty(), "Expected no possible moves for the piece");
  }

  @Test
  public void testGetPossibleMovesForPiece_MultipleMoves() {
    GameState gameState = gameStateFactory.createSampleGameState();
    moveSelector = new MoveSelector(gameState);
    List<Move> possibleMoves = moveSelector.getAllPossibleMoves();
    assertTrue(possibleMoves.size() > 1, "Expected multiple possible moves for the piece");
  }

  @Test
  public void testGetPossibleMovesForPiece_BlockedByPieces() {
    GameState gameState = gameStateFactory.createCustomTestGameState(1, 2, "vertical",
        new int[]{3, 3}, new int[]{4, 3}, false);
    moveSelector = new MoveSelector(gameState);
    List<Move> possibleMoves = moveSelector.getAllPossibleMoves();
    assertEquals(1, possibleMoves.size(),
        "Expected no possible moves for the piece due to blocking pieces");
  }

  @Test
  public void testGetPossibleMovesForPiece_DifferentMovementTypes() {
    GameState gameState = gameStateFactory.createCustomTestGameState(1, 2, "diagonal",
        new int[]{3, 3}, new int[]{5, 5}, true);
    moveSelector = new MoveSelector(gameState);
    List<Move> possibleMoves = moveSelector.getAllPossibleMoves();
    assertFalse(possibleMoves.isEmpty(),
        "Expected possible moves for the piece with diagonal movement");
    ...
    possibleMoves = moveSelector.getAllPossibleMoves();
    assertFalse(possibleMoves.isEmpty(),
        "Expected possible moves for the piece with L-shaped movement");
  }
  ...
  public void testIsValidMove_CaptureOpponent() {
    ...
    assertTrue(containsMove,
        "Expected move to be valid for capturing opponent piece");
  }
  ...
  public void testIsPathClear_ClearPath() {
    ...
    assertTrue(containsMove,
        "Expected path to be clear for the move");
  }
  ...
  public void testHandlePositionContent_EmptyPosition() {
    ...
    assertTrue(containsMove,
        "Expected move to empty position to be valid");
  }
  ...
  public void testHandlePositionContent_OccupiedByOpponentBase() {
    ...
    assertTrue(containsMove,
        "Expected move to capture opponent base to be valid");
  }
  ...
  public void testValidateMoveDirection_ValidVertical() {
    ...
    assertTrue(containsMove,
        "Expected valid vertical move to be allowed");
  }
  ...
  public void testValidateMoveDirection_ValidDiagonal() {
    ...
    assertTrue(containsMove,
        "Expected valid diagonal move to be allowed");
  }
  ...
  public void testValidateMoveDirection_ValidLShaped() {
    ...
    assertTrue(containsMove,
        "Expected valid L-shaped move to be allowed");
  }
  ...
  public void testSelectRandomMove_SingleMove() {
    ...
    assertTrue(containsMove,
        "Expected the selected move to be a possible move");
  }
