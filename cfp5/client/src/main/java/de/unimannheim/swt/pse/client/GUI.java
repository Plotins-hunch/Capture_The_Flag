...
import de.unimannheim.swt.pse.client.controller.LoadingScreenController;
...
public class GUI extends Application {
  ...
  public static MapTemplate sampleMap;
  public static MapTemplate sampleMap2;
  public static MapTemplate sampleMap3;
  public static Team sampleTeam;

  public static ArrayList<MapTemplate> maps = new ArrayList<>();
  ...
  public void start(Stage stage) throws Exception {
    ...
    fxmlLoader.setLocation(getClass().getResource("/fxml/loadingScreen.fxml"));
    Parent root = fxmlLoader.load();

    //Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("/fxml/GameMenu.fxml"));
    Image img = new Image(getClass().getResource("/assets/loadingScreen.png").toString());
    LoadingScreenController controller = fxmlLoader.getController();
    Image logo = new Image(getClass().getResource("/assets/gameLogo.png").toString());
  ...
  public static void main(String[] args) throws IOException {
    ...
    pc1.setId("1");
    pc1.setTeamId("1");
    pc1.setDescription(p1);
    Piece pc2 = new Piece();
    pc2.setId("2");
    pc2.setTeamId("1");
    pc2.setDescription(p2);
    pieces[1] = pc2;
    pieces[0] = pc1;
    Piece pc3 = new Piece();
    pc3.setId("3");
    pc3.setTeamId("1");
    pc3.setDescription(p3);
    pieces[2] = pc3;
    sampleTeam.setPieces(pieces);
