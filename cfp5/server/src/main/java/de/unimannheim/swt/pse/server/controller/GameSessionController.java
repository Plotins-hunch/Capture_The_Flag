...
import de.unimannheim.swt.pse.server.game.exceptions.ForbiddenMove;
...
public class GameSessionController {
     ...
     *
     * @param request {@link de.unimannheim.swt.pse.server.controller.data.GameSessionRequest}
     ...
     *
     * @param sessionId   unique session id
     * @param moveRequest {@link de.unimannheim.swt.pse.server.controller.data.MoveRequest}
     */
     ...
     *
     * @param sessionId unique session id
     * @param giveupRequest {@link de.unimannheim.swt.pse.server.controller.data.GiveupRequest}
     */
