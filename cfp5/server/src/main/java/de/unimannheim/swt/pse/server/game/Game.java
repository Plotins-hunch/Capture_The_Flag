 ...
 *
 * The game engine is supposed to implement logic (rules) that cover all fields in {@link de.unimannheim.swt.pse.server.game.map.MapTemplate} (e.g., time limitations etc.).
 *
...
public interface Game {
    ...
    /**
     * Initializes a new game based on given {@link de.unimannheim.swt.pse.server.game.map.MapTemplate} configuration.
     *
     ...
     * @return Team
     * @throws de.unimannheim.swt.pse.server.game.exceptions.NoMoreTeamSlots No more team slots available
     */
     ...
     * @throws de.unimannheim.swt.pse.server.game.exceptions.InvalidMove Requested move is invalid
     * @throws de.unimannheim.swt.pse.server.game.exceptions.GameOver    Game is over
     */
